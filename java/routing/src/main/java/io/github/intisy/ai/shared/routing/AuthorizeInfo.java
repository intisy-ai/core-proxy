 ...
 * local redirect listener rather than asking the operator to paste a code) — documented as part
 * of this wire shape by the existing dashboard consumer ({@code OAuthAdmin}) though no current
 * provider populates them yet.
 */
